...
class HomePage(tk.Frame):    
    ...
    def create_widgets(self):
        ...
        frm_search.grid(row=0,column=0,padx=HOME_CONTENT_PADX,pady=(0,10),sticky="nsew")
        ...
        # Search Entry #
        search_bar = tk.Entry(master=frm_search_top,textvariable=self.search_text)
        ...
        lbl_center = tk.Label(master=frm_borrowed,text="Borrowed books",bg="red")
        ...
        lbl_reserved = tk.Label(master=frm_reserved,text="Reserved books",bg="yellow")
